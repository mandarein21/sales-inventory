...
app.use((req, res, next) => {
    res.locals.admin = req.session.admin || null; // Make admin available in views
    next();
});
...
app.post('/login', async (req, res) => {
    ...
    try {
        ...
        req.session.admin = user; // Store the user in session
        console.log('User Logged In:', req.session.admin); // Confirm user is set in session
...
app.get('/products', (req, res) => {
    console.log('Current Session on Products:', req.session); // Debugging session
    res.render('product'); // Pass necessary data to the view
});
...
app.get('/products', async (req, res) => {
    try {
        ...
        console.log(products); // Check if products contain the expected data

        // Render the view and pass products to the EJS file
...
app.get('/products', async (req, res) => {
    try {
        ...
        // Create an admin object with necessary properties
        const admin = isAdmin ? { Username: req.user.username } : null;

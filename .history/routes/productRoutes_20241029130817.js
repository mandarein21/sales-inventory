...
router.get('/products/:id', async (req, res) => {
    try {
        // Use the correct ID from the request parameters
        const productId = req.params.id;

        // Find the product by ID
        const product = await Product.findById(productId).populate('CategoryID'); // Populate if you want category details

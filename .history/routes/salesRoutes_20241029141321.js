...
router.get('/api/products', async (req, res) => {
    const { categoryId } = req.query; // Changed variable name to categoryId for clarity
    ...
    try {
        const products = await Product.find({ Category: categoryId }); // Ensure you're filtering by Category field

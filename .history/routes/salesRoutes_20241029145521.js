...
router.get('/api/products', async (req, res) => {
    ...
    console.log("Category ID received:", categoryId); // Debug line
    console.log("Type of categoryId:", typeof categoryId); // Debug line
    ...
    try {
        // Convert categoryId to ObjectId before querying
        const objectId = mongoose.Types.ObjectId(categoryId);
        console.log("Converted ObjectId:", objectId); // Debug line

        const products = await Product.find({ CategoryID: objectId }); // Use ObjectId for querying
        console.log("Products found:", products); // Debug line

...
const getProductById = async (req, res) => {
    const productId = req.params.id; // Get ID from the request parameters
    try {
        const product = await Product.findOne({ ProductID: productId }); // Adjust this if you are using another identifier

...
const empDashboard = async (req, res) => {
    try {
        const totalOrders = await getTotalOrders(); // Function to get total orders
...
// Example function to get total orders
const getTotalOrders = async () => {
    // Replace with your actual logic to fetch total orders
    const orders = await OrdersModel.countDocuments(); // Example using Mongoose
    return orders;
};

...
app.delete('/sales/:saleId', async (req, res) => {
    const saleId = req.params.saleId; // This will be a string

    try {
        // Use findOneAndDelete if SaleID is not an ObjectId
        const deletedSale = await Sale.findOneAndDelete({ SaleID: saleId });

...
app.post('/login', async (req, res) => {
    ...
    try {
        ...
        console.log('Session after setting admin:', req.session); // Check full session state
...
app.get('/products', async (req, res) => {
    console.log('Current Session on Products:', req.session); // Debugging session data
    try {
        // Check if session admin is populated
        const isAdmin = req.session.admin && req.session.admin.role === 'admin';
        console.log('Is Admin:', isAdmin); // Log if the user is admin

        const admin = isAdmin ? { Username: req.session.admin.Username } : null;
        console.log('Admin Object:', admin); // Check if admin object is populated correctly
